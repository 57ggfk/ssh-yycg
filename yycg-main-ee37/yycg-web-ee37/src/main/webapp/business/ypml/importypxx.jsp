...
<body>
<form id="importypxxForm" name="ypxximportForm" action="${baseurl}/ypml/importypxx_submit.action" method="post" enctype="multipart/form-data">
						...
						<TBODY>
							...
							<TR>
								...
								<TD colspan=2  align=center class=category>
									<a id="submitbtn" href="#" onclick="importypxxsubmit()" class="easyui-linkbutton" data-options="iconCls: 'icon-ok'">导入</a>
