 ...
 * 2016-12-13T16:55:48.930+08:00
 * Generated source version: 3.0.9
 * 
 */
@WebServiceClient(name = "WeatherWS", 
                  wsdlLocation = "file:/D:/Java/workspaceYYCG/webservice-client-ee37/target/classes/WeatherWS.asmx.xml",
...
public class WeatherWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Java/workspaceYYCG/webservice-client-ee37/target/classes/WeatherWS.asmx.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWS.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/Java/workspaceYYCG/webservice-client-ee37/target/classes/WeatherWS.asmx.xml");
        }
        WSDL_LOCATION = url;
    }
