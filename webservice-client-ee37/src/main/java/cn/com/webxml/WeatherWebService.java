 ...
 * 2016-12-20T13:57:15.150+08:00
 * Generated source version: 3.0.9
 * 
 */
@WebServiceClient(name = "WeatherWebService", 
                  wsdlLocation = "file:/E:/WeatherWebService.xml",
...
public class WeatherWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/WeatherWebService.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWebService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/WeatherWebService.xml");
        }
        WSDL_LOCATION = url;
    }
